            ...
            >
              ...
              {!isLoading && user &&
                <>
                  ...
                  <Setting onClick={() => {logOut().finally(() => {});}} icon={<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' className='bi bi-box-arrow-left' viewBox='0 0 16 16'>
